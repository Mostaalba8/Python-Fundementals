...
leaf_shinobi.list_of_powers[user_preference] = randint(1,100) if user_preference not in leaf_shinobi.list_of_powers else None
if leaf_shinobi.list_of_powers[user_preference] > 50 and  leaf_shinobi.list_of_powers[user_preference] <= 80:
    print('COOL')
elif  leaf_shinobi.list_of_powers[user_preference] > 80:
    print('SUPER COOL')
print(leaf_shinobi.list_of_powers)
